    ...
    public void setUp() throws MalformedURLException {
        ...
        switch (ambiente) {
            ...
            case "remoto": // No SauceLabs
                ...
                desiredCapabilities.setCapability("appActivity", "com.android.calculator2.Calculator");
                desiredCapabilities.setCapability("ensureWebviewsHavePages", true);
                desiredCapabilities.setCapability("SAUCE_USERNAME", "ppripereira");
                desiredCapabilities.setCapability("SAUCE_ACCESS_KEY", "bdcd548b-92cf-40d8-b594-03f386eafee5");

                remoteUrl = new URL("https://ppripereira:bdcd548b-92cf-40d8-b594-03f386eafee5@ondemand.us-west-1.saucelabs.com:443/wd/hub");
                break;
            default:
                remoteUrl = new URL("http://localhost:4723/wd/hub");
                break;
